...
- **CRITICAL**: Format all mathematical formulas and symbols using LaTeX syntax. For example, render x squared as \\(x^2\\) and fractions as \\(\\frac{a}{b}\\). Ensure it is valid LaTeX.
