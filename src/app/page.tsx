                    ...
                    <Card className="bg-card/50 backdrop-blur-lg border-border/20 shadow-xl shadow-primary/10 overflow-hidden">
                        <div className="md:grid md:grid-cols-2 items-center">
                            ...
                            <div className="bg-muted/50 p-8 text-center">
                                ...
                                <div className="flex justify-center space-x-4">
                                    <a href="https://chat.whatsapp.com/CdRg24RV7ozFs052jfpGi9" target="_blank" rel="noopener noreferrer" className="flex h-12 w-12 items-center justify-center rounded-lg border bg-background text-muted-foreground transition-colors hover:bg-primary hover:text-primary-foreground" aria-label="WhatsApp"><FaWhatsapp /></a>
